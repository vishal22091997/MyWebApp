              ...
              <div class="col-sm-12">
                <table class="table table-striped table-border checkout-table">
                  <tbody>
                    ...
                    <tr>
                      <td class="hidden-xs"><a href="#"><img src="assets/images/shop/ " alt="Accessories Pack"/></a></td>
                      <td>
                      ...
                      <td>
                        <input class="form-control" type="number" name="count " value=" " max="50" min="1"/>
                      </td>
                      <td>
                        <h5 class="product-title font-alt"> </h5>
                      </td>
                      <td class="pr-remove"><a href="RemoveFromCart?id= " title="Remove"><i class="fa fa-times"></i></a></td>
                    </tr>
